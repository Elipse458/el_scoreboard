Config = {
    ...
    connect_history = 10, -- number of connects to keep in the log
    disconnect_history = 10, -- number of disconnects to keep in the log
    admin_groups = {"admin","superadmin"}, -- admin groups
